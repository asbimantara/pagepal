        ...
        <div class="form-card">
            ...
            <form method="POST" class="book-form">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="total_pages" name="total_pages" required min="1" max="99999"
                ...
                <div class="form-group">
                    ...
                    <div class="cover-method">
                        <button type="button" class="btn-method active" onclick="switchMethod('default')">Pilih Sampul
                            Default</button>
                    ...
                    <input type="hidden" id="cover_url" name="cover_url"
                        value="<?php echo $defaultBookCovers[0]['url']; ?>">
