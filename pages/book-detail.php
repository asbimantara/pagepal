                ...
                <div class="book-info">
                    ...
                    <div class="progress-info">
                        <div class="progress-bar">
                            <div class="progress" style="width: <?php echo ($book->current_page / $book->total_pages) * 100; ?>%"></div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="page-input-container">
                            <input type="number" 
                                   ...
                                   oninput="validatePageNumber(this)"
                                   value="1">
                            ...
                            <div class="note-card">
                                <div class="note-header">
                                    ...
                                    <div class="note-actions">
                                        <button onclick="editNote(<?php echo $noteIndex; ?>, '<?php echo htmlspecialchars(addslashes($note->content)); ?>', <?php echo $note->page; ?>)" 
                                                class="btn-icon" 
                                                title="Edit catatan">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                        <button onclick="deleteNote(<?php echo $noteIndex; ?>)" 
                                ...
                                <?php if (strlen($note->content) > 200): ?>
                                    <button class="note-content-toggle" onclick="toggleNoteContent(this)">Lihat Selengkapnya</button>
                                <?php endif; ?>
                            </div>
                        <?php endforeach; ?>
                    <?php else: ?>
        ...
        <div class="modal-content">
            ...
            <form id="editNoteForm" method="POST" action="edit-note.php">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="editNotePage" name="page" required min="1" max="<?php echo $book->total_pages; ?>">
                </div>
